...
import { RecurringExpensesSummary } from '@/adapters/budget/components/RecurringExpensesSummary'
...
vi.mock('@/adapters/budget/hooks/useCategories', () => ({
  useCategories: vi.fn(),
}))
...
import { useCategories } from '@/adapters/budget/hooks/useCategories'
